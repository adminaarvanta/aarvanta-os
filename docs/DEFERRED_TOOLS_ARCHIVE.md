# Deferred tools archive

> **Removed from product on 2026-08-13.** The modules below were deleted from the app (pages, product API shells, and platform module entries). This file is kept for future reference only.
