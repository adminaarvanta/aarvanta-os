...
export const INDUSTRY_PROFILES: IndustryProfile[] = [
  {
    ...
    defaultWorkflows: ["hot_lead_chase", "first_outreach_whatsapp", "proposal_handoff"],
    defaultBuddies: [
      "sales_buddy",
      "marketing_buddy",
      "accounting_buddy",
  ...
  },
  {
    ...
    defaultWorkflows: ["first_outreach_whatsapp", "book_discovery"],
  ...
  },
  {
    ...
    defaultWorkflows: ["book_discovery", "hot_lead_chase"],
  ...
  },
  {
    ...
    defaultWorkflows: ["deal_followup", "proposal_handoff"],
  ...
  },
  {
    ...
    defaultWorkflows: ["hot_lead_chase", "deal_followup"],
