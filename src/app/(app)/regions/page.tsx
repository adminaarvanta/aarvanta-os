  ...
  return (
    ...
    >
      <div className="space-y-8">
        ...
        <section>
          <h3 className="mb-3 text-sm font-semibold text-foreground">Global region map</h3>
          <CardList
        ...
        <section>
          <h3 className="mb-3 text-sm font-semibold text-foreground">Tenant assignments</h3>
          <CardList
