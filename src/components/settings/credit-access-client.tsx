  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <Panel>
        <SectionHeader
          title="Credit access"
          description="Grant unlimited Voice OS minutes and Email OS outreach to any product user. Recipients should refresh the app (or sign out and back in) after you save."
        />
