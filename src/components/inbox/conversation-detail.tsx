...
function ConversationSidebar({
  ...
  return (
    <>
      ...
      <div>
        <p className="mb-2 text-xs font-semibold uppercase tracking-wide text-[#9AABC4]">
          Tags
        </p>
        <TagPicker
      ...
      <div className="border-t border-[#243656] pt-4">
...
export function ConversationDetail({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col overflow-hidden lg:flex-row">
      ...
      <section className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden bg-[#040608]">
        <header className="hidden shrink-0 border-b border-[#243656] px-4 py-3 sm:px-6 sm:py-4 lg:block">
          <h2 className="text-base font-semibold text-[#FFFFFF] sm:text-lg">
            {conversation.contact.name}
          </h2>
          <div className="mt-1 flex flex-col gap-0.5 text-xs text-[#9AABC4] sm:flex-row sm:flex-wrap sm:gap-2 sm:text-sm">
        ...
        <div
          ...
          className="min-h-0 flex-1 overflow-y-auto overscroll-contain bg-[#040608] p-4 sm:p-6"
        >
          <p className="mb-4 text-xs font-semibold uppercase tracking-wide text-[#9AABC4]">
            Conversation timeline
          </p>
          <ConversationTimeline events={conversation.timeline} />
        </div>

        <details className="group shrink-0 border-t border-[#243656] bg-[#0D1524] lg:hidden">
          <summary className="cursor-pointer list-none px-4 py-2.5 text-xs font-semibold uppercase tracking-wide text-[#9AABC4] marker:content-none [&::-webkit-details-marker]:hidden">
            Tags, AI insights & notes
          </summary>
          <div className="space-y-6 border-t border-[#243656] p-4">
            <ConversationSidebar
              conversation={conversation}
              aiStatus={aiStatus}
              hrCases={hrCases}
      ...
      <aside className="hidden w-80 shrink-0 min-h-0 space-y-6 overflow-y-auto overscroll-contain border-l border-[#243656] bg-[#0D1524] p-4 lg:block">
        <ConversationSidebar
          conversation={conversation}
          aiStatus={aiStatus}
          hrCases={hrCases}
