...
function DetailSkeleton() {
  return (
    <div className="flex min-h-0 flex-1 flex-col lg:flex-row">
      ...
      <aside className="w-full space-y-6 border-t border-border p-4 lg:w-80 lg:border-t-0 lg:border-l">
...
export function ConversationPageLoading({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col" aria-busy="true" aria-live="polite">
      ...
      <header className="shrink-0 flex items-center gap-3 border-b border-border bg-surface-elevated px-4 py-3 sm:px-6">
