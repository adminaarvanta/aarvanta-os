...
function ToolsPanel({
  ...
  return (
    <div
      ...
      className="fixed top-0 z-50 flex h-full w-[min(720px,calc(100vw-13rem))] flex-col bg-surface-elevated shadow-[8px_0_48px_rgba(0,0,0,0.45)]"
    ...
    >
      ...
      <div className="space-y-2 px-4 py-3 shadow-[0_-8px_16px_-12px_rgba(0,0,0,0.45)]">
        <a
          href="/chat"
          target="_blank"
...
function SidebarFooterLink({
  ...
  return (
    <a
      ...
      className="relative flex h-10 w-full items-center gap-2 rounded-lg px-2 text-muted transition-colors hover:bg-surface-hover hover:text-foreground"
    >
...
function NavItem({
  ...
  return (
    <PendingLink
      ...
      pendingClassName="opacity-60"
      className={cn(
        "relative flex h-10 w-full items-center gap-2 rounded-lg px-2 transition-colors duration-150",
        active
    ...
    <>
      <div className="relative z-20 hidden shrink-0 md:flex">
        <aside
          ...
          className="flex w-52 min-h-0 shrink-0 flex-col overflow-hidden bg-surface shadow-[4px_0_32px_rgba(0,0,0,0.4)]"
        >
          <div className="flex shrink-0 flex-col items-center border-b border-border-subtle px-3 py-5">
            <Link
              href="/dashboard"
              onClick={closeToolsPanel}
              title="Aarvanta Business OS"
              className="flex w-full flex-col items-center rounded-lg transition-opacity hover:opacity-90"
            >
              <BrandLogo variant="icon" size="sidebar" />
            </Link>
          </div>
          ...
          <nav className="min-h-0 flex-1 overflow-y-auto overscroll-contain p-2">
            ...
            <div className="mt-3 pt-1">
              ...
              >
                ...
                <span className="truncate text-sm font-medium">All tools</span>
              </button>
            </div>
          </nav>
