...
- `GET /api/voice/calendar` · `POST|DELETE /api/voice/calendar` · `POST /api/voice/calendar/sync` — per-user Voice OS calendar (invite mailbox, optional iCal, OAuth when published)
